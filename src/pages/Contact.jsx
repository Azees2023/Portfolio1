  ...
  return (
    <div className='text-gray-300  w-full h-screen flex lg:text-center text-center'>
      <div className='flex flex-col justify-center items-center w-full h-full '>
        <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8 top-[-130px] relative'>
          <div className='sm:text-right pb-8   pl-4'>
             <h2 className='text-4xl font-bold inline border-b-4  border-pink-600 absolute ml-[-300px] animate-fade-right '>About</h2>
          </div>
          {/* <div>
          ...
          <div className=' top-[70px] relative left-[-610px] w-full grid grid-cols-2 gap-8 lg:text-center lg:ml-52  sm:ml-36'>
